...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "buyAnyPiece": MessageLookupByLibrary.simpleMessage(
      "اشتري كل القطع لمنزلك بسهولة ",
    ),
    "buyAnyPieceSubtitle": MessageLookupByLibrary.simpleMessage(
      "نتطلع لتقديم خدمة متكاملة لأعمال صيانة المنازل التي يحتاج  إليها ٍ عملائنا بشكل احترافي لنكون الخيار الأول لهم",
    ),
    "chooseYourPreferedService": MessageLookupByLibrary.simpleMessage(
      "أختر كل ما تحتاجه من خدماتنا",
    ),
    "chooseYourServiceSubtitle": MessageLookupByLibrary.simpleMessage(
      "متخصصة في مجال الكهرباء، تكييف، مصاعد، السباكة،وخدماتأخرى وتمتلك الشركة خبرات وكوادر ذات كفاءة عالية",
    ),
    "conditionsText": MessageLookupByLibrary.simpleMessage(
    ...
    "offeringVIPService": MessageLookupByLibrary.simpleMessage(
      "توفير  خدمة (VIP)",
    ),
    "offeringVIPServiceSubtitle": MessageLookupByLibrary.simpleMessage(
